...
function AllowanceCalculator() {
  ...
  // UI
  return (
    <div className="allowance-calc-container dark:bg-gray-900 dark:text-gray-100">
      <div className="allowance-calc-title dark:text-blue-300">임금 계산기</div>
      <div className="allowance-calc-desc dark:text-gray-300">정확한 임금 계산을 도와드립니다.</div>
      <div className="allowance-calc-choices">
        <div className="contract-form-page">
          <div className="contract-form-container">
            <div className="form-header">
              <button className="back-btn" onClick={() => navigate('/allowance-menu')}>뒤로</button>
